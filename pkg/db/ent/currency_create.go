...
func (cc *CurrencyCreate) defaults() error {
	...
	if _, ok := cc.mutation.EntID(); !ok {
		if currency.DefaultEntID == nil {
			return fmt.Errorf("ent: uninitialized currency.DefaultEntID (forgotten import ent/runtime?)")
		}
...
func (cc *CurrencyCreate) check() error {
	...
	if _, ok := cc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`ent: missing required field "Currency.ent_id"`)}
	}
	return nil
}
