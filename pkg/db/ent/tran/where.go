...
func IDEQ(id int) predicate.Tran {
	return predicate.Tran(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id int) predicate.Tran {
	return predicate.Tran(func(s *sql.Selector) {
...
func IDIn(ids ...int) predicate.Tran {
	return predicate.Tran(func(s *sql.Selector) {
...
func IDNotIn(ids ...int) predicate.Tran {
	return predicate.Tran(func(s *sql.Selector) {
		v := make([]interface{}, len(ids))
		for i := range v {
			v[i] = ids[i]
...
func IDGT(id int) predicate.Tran {
	return predicate.Tran(func(s *sql.Selector) {
...
func IDGTE(id int) predicate.Tran {
	return predicate.Tran(func(s *sql.Selector) {
...
func IDLT(id int) predicate.Tran {
	return predicate.Tran(func(s *sql.Selector) {
...
func IDLTE(id int) predicate.Tran {
	return predicate.Tran(func(s *sql.Selector) {
