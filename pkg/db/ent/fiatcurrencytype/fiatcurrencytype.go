...
const (
	// Label holds the string label denoting the fiatcurrencytype type in the database.
	Label = "fiat_currency_type"
...
// Columns holds all SQL columns for fiatcurrencytype fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
