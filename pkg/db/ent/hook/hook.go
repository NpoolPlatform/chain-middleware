...
type ChainBaseFunc func(context.Context, *ent.ChainBaseMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ChainBaseFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.ChainBaseMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ChainBaseMutation", m)
	}
	return f(ctx, mv)
}
...
// Mutate calls f(ctx, m).
func (f CoinFiatCurrencyFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.CoinFiatCurrencyMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.CoinFiatCurrencyMutation", m)
	}
	return f(ctx, mv)
}
...
type CoinFiatCurrencyHistoryFunc func(context.Context, *ent.CoinFiatCurrencyHistoryMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f CoinFiatCurrencyHistoryFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.CoinFiatCurrencyHistoryMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.CoinFiatCurrencyHistoryMutation", m)
	}
	return f(ctx, mv)
}
