...
// functions as a query rule.
type ChainBaseQueryRuleFunc func(context.Context, *ent.ChainBaseQuery) error

// EvalQuery return f(ctx, q).
func (f ChainBaseQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.ChainBaseQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.ChainBaseQuery", q)
}

// The ChainBaseMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type ChainBaseMutationRuleFunc func(context.Context, *ent.ChainBaseMutation) error

// EvalMutation calls f(ctx, m).
func (f ChainBaseMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.ChainBaseMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.ChainBaseMutation", m)
}
...
// functions as a query rule.
type CoinFiatQueryRuleFunc func(context.Context, *ent.CoinFiatQuery) error

// EvalQuery return f(ctx, q).
func (f CoinFiatQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.CoinFiatQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.CoinFiatQuery", q)
}

// The CoinFiatMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type CoinFiatMutationRuleFunc func(context.Context, *ent.CoinFiatMutation) error

// EvalMutation calls f(ctx, m).
func (f CoinFiatMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.CoinFiatMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.CoinFiatMutation", m)
}

// The CoinFiatCurrencyQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type CoinFiatCurrencyQueryRuleFunc func(context.Context, *ent.CoinFiatCurrencyQuery) error

// EvalQuery return f(ctx, q).
func (f CoinFiatCurrencyQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.CoinFiatCurrencyQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.CoinFiatCurrencyQuery", q)
}

// The CoinFiatCurrencyMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type CoinFiatCurrencyMutationRuleFunc func(context.Context, *ent.CoinFiatCurrencyMutation) error

// EvalMutation calls f(ctx, m).
func (f CoinFiatCurrencyMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.CoinFiatCurrencyMutation); ok {
		return f(ctx, m)
	}
...
// functions as a query rule.
type CoinUsedForQueryRuleFunc func(context.Context, *ent.CoinUsedForQuery) error

// EvalQuery return f(ctx, q).
func (f CoinUsedForQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.CoinUsedForQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.CoinUsedForQuery", q)
}

// The CoinUsedForMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type CoinUsedForMutationRuleFunc func(context.Context, *ent.CoinUsedForMutation) error

// EvalMutation calls f(ctx, m).
func (f CoinUsedForMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.CoinUsedForMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.CoinUsedForMutation", m)
}
