# Npool chain middleware

[![Test](https://github.com/NpoolPlatform/chain-middleware/actions/workflows/main.yml/badge.svg?branch=master)](https://github.com/NpoolPlatform/chain-middleware/actions/workflows/main.yml)
...
* make chain-middleware ```单独编译服务```
* make chain-middleware-image ```单独生成服务镜像```
